...
_I recently started a new contract that involves tools and software languages I normally don't use.   I have to remember that [.NET](https://www.microsoft.com/net/) best practices don't necessarily translate to [PHP](http://www.php.net/)/[Java](https://java.com).  I have to remember that [New Tools Require New Standards](https://nftb.saturdaymp.com/new-tools-require-new-standards/) (originally published on September 3rd, 2010)._
