...
\[gallery ids="908,914,913,912,911,909"\]

\[showhide type="post" more\_text="Show more..." less\_text="Show less..."\]

Right off the bat, I picked a compression index of 50**_\*_** and saw almost no difference, other than size of the jpeg.
...
Using [Mini-Compressor](http://saturdaymp.com/mini_comp "Mini-Compressor") to reduce the size of your jpegs is no trick – just treats – smaller images with quality intact!

Happy Hallowe’en wherever you are!

_**\*** Not sure how to change your compression index?  Check out the [Mini-Guide to Mini-Compressor](http://saturdaymp.com/manuals/MiniGuideToMiniCompressor.pdf "Mini-Guide to Mini-Compressor").  This is where you can also learn to change the Compressed Image Suffix.  That’s the \_## that I use to keep track of which compression index I’ve used._
