...
In this episode I solve the Forbidden Paths and Login [picoCTF](https://picoctf.org/) challenges. You can find the source code in the video [here](https://github.com/mrbiggred/picoCTF).

https://youtu.be/IiJC2aLvGkA
