...
\[text\] \[09:23:28\]\[Foo\\Foo.iOS\\Foo.iOS.csproj\] \_SayGoodbye \[09:23:28\]\[\_SayGoodbye\] SayGoodbye \[09:23:28\]\[SayGoodbye\] Compute signature for bin\\iPhone\\Release\\FooiOS.app \[/text\]
...
\[text\] MSBUILDDISABLENODEREUSE=1 \[/text\]

The command switch in question is:

\[text\] msbuild YourApp.sln /m:4 /nr:false /t:rebuild \[/text\]
...
\[text\] set MSBUILDDISABLENODEREUSE=1 "C:\\Program Files (x86)\\MSBuild\\14.0\\Bin\\msbuild.exe" YouApp.sln /m:4 /nr:false /t:rebuild /p:Configuration=Release /p:Platform=iPhone /p:ServerAddress=%MacIP% /p:ServerUser=%MacUser% /p:ServerPassword=%MacPassword% /p:ContinueOnDisconnected=false \[/text\]
...
\[text\] Stop-Process -processname msbuild \[/text\]
